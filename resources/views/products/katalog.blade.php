...
<body class="bg-[#F3F4F6] text-gray-800">
    ...
    @php
        ...
        $defaultImage = 'data:image/svg+xml;base64,' . base64_encode('<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300"><rect fill="#ddd" width="300" height="300"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Arial" font-size="18" fill="#666">No Image</text></svg>');
    @endphp
