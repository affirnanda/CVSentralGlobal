                    ...
                    <form method="POST" action="{{ route('admin.hero-section.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="hero_subtitle" name="hero_subtitle" rows="3"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm {{ $errors->has('hero_subtitle') ? 'border-red-500 ring-red-500' : '' }}">{{ old('hero_subtitle', $data['hero_subtitle'] ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="section_text" name="section_text" rows="3"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm {{ $errors->has('section_text') ? 'border-red-500 ring-red-500' : '' }}">{{ old('section_text', $data['section_text'] ?? '') }}</textarea>
                        </div>
